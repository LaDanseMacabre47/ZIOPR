...
extern const MIDL_SERVER_INFO TrayService_ServerInfo;

extern const RPC_DISPATCH_TABLE TrayService_v1_0_DispatchTable;

static const RPC_SERVER_INTERFACE TrayService___RpcServerInterface =
    {
    sizeof(RPC_SERVER_INTERFACE),
    {{0xAABBCCDD,0x1234,0x5678,{0xAB,0xCD,0x12,0x34,0x56,0x78,0x90,0xAB}},{1,0}},
    {{0x8A885D04,0x1CEB,0x11C9,{0x9F,0xE8,0x08,0x00,0x2B,0x10,0x48,0x60}},{2,0}},
    (RPC_DISPATCH_TABLE*)&TrayService_v1_0_DispatchTable,
    0,
    0,
    0,
    &TrayService_ServerInfo,
    0x04000000
    };
RPC_IF_HANDLE TrayService_v1_0_s_ifspec = (RPC_IF_HANDLE)& TrayService___RpcServerInterface;
#ifdef __cplusplus
namespace {
#endif
...
static const MIDL_STUB_DESC TrayService_StubDesc = 
    {
    (void *)& TrayService___RpcServerInterface,
    MIDL_user_allocate,
    MIDL_user_free,
    0,
    0,
...
static const RPC_DISPATCH_FUNCTION TrayService_table[] =
    {
    NdrServerCall2,
    NdrServerCall2,
    NdrServerCall2,
...
static const SERVER_ROUTINE TrayService_ServerRoutineTable[] = 
    {
...
static const MIDL_SERVER_INFO TrayService_ServerInfo = 
    {
    &TrayService_StubDesc,
    TrayService_ServerRoutineTable,
    TrayService__MIDL_ProcFormatString.Format,
    TrayService_FormatStringOffsetTable,
    0,
    0,
    0,
    0};
